...
class Controller:
    ...
    @staticmethod
    def get_information_about_card_password():
        return CardAccount.get_information_about_card("password")
    ...
    @staticmethod
    def set_information_about_card_status(status: str):
        return CardAccount.set_information_about_card("status", status, False)

    @staticmethod
    def set_information_about_card_attempts(attempts: int):
        return CardAccount.set_information_about_card("attempts", attempts, True)

    @staticmethod
    def set_information_about_card_balance(balance: int):
        return CardAccount.set_information_about_card("balance", balance, True)

    @staticmethod
    def set_information_about_card_withdrawal(withdrawal: int):
    ...
    def pin_validate(pin: str):
        ...
        try:
            ...
            return False
        if len(pin) == 4 and pin == str(password) and status == "unlocked":
            return True
        return False
