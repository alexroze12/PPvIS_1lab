...
parser.add_argument("-w", "--withdrawal", help="Amount of withdrawal money and write check about operation", nargs="?",
                    const=cash_for_withdrawal)
...
if status_of_card == "locked":
    if args.unlock:
        ...
        exit()
if Controller.pin_validate(str(args.p)) == False and Controller.pin_validate(
        str(args.sp)) == False and Controller.pin_validate(str(args.tp)) == False:
